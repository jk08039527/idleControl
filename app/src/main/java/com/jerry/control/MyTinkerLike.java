...
import com.jerry.baselib.BaseApplike;
 ...
 * </pre>
 */
public class MyTinkerLike extends BaseApplike {

    public MyTinkerLike() {
        super(ShareConstants.TINKER_ENABLE_ALL, "com.jerry.control.MyApplication");
    }
}
